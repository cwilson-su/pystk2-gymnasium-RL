...
def plot_track_3d(csv_file):
    ...
    output_html = os.path.join(os.path.dirname(os.path.abspath(__file__)), "track_visualization.html")
    fig.write_html(output_html)  # Save the interactive graph as an HTML file(the file can be opened in a browser for gitHub)
